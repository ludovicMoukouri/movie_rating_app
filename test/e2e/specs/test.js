...
.setValue('input#email', 'ludovicmoukouri@yahoo.fr')
...
.pause(1000)
.assert.containsText('#user_email', 'LUDOVICMOUKOURI@YAHOO.FR')
.click('#add_movie_link')
.pause(2000)
.assert.elementCount('input', 5)
.setValue('input#name', 'Avengers: Infinity War')
.setValue('input#description', 'Iron Man, Thor, the Hulk and the rest of the Avengers unite to battle their most powerful enemy yet -- the evil Thanos. On a mission to collect all six Infinity Stones, Thanos plans to use the artifacts to inflict his twisted will on reality.')
